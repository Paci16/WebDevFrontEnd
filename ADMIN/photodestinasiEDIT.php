...
<?php 
	...
	if(isset($_POST['edit']))
	{
            ...
            if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "png") or ($ekstensifile == "PNG"))
		{
			...
			lokasiWISATA = '$lokasiwisata', fotoWISATA = '$namafile' 
			WHERE namaWISATA = '$namawisata'");
		}
	} else {
		mysqli_query($connection, "UPDATE fotodestinasi SET 
		lokasiWISATA = '$lokasiwisata' WHERE namaWISATA = '$namawisata'");
	}
...
<div style="padding-left: 0; margin-bottom: 15px;" class="container">
			<h4 class="display-8">Input data Foto Wisata</h4>
		</div>
	</div>

	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row">
			<label for="inputnama" class="col-sm-2 col-form-label">Nama Wisata</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="inputnama" name="inputnama" 
				value="<?php echo $roweditfoto['namaWISATA']; ?>" readonly>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="inputlokasi" name="inputlokasi" 
				value="<?php echo $roweditfoto['lokasiWISATA']; ?>">
			</div>
		</div>
		...
		<div style="margin-top: 10px;" class="form-group row">
			...
			<div class="col-sm-10">
				<td>
    	<?php if (!empty($row['fotoWISATA']) && is_file("images/".$row['fotoWISATA'])): ?>
        	<img src="images/<?php echo $row['fotoWISATA']?>" width="80" alt="Current Image">
    	<?php endif; ?>
	</td>
    ...
    <div class="form-group row mb-2 mt-3">
      <label for="search" class="col-sm-2">Nama Wisata</label>
      <div class="col-sm-6">
