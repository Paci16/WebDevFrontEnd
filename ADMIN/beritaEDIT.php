...
<?php
    ...
    { 
        ...
        mysqli_query($connection, "update berita set event0108 = '$event0108',
            beritaJUDUL = '$beritaJUDUL', kategoriberitavalencia = '$kategoriberitavalencia'
            ...
            <form method="POST">
                <div class="mb-3 row"> 
                    ...
                    <div class="col-sm-10">
                        ...
                        value="<?php echo $rowedit["berita0108"]?>" readonly>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="<?php echo $rowedit["kategoriberitavalencia"]?>">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="<?php echo $rowedit["event0108"]?>">
                    </div>
                </div>
