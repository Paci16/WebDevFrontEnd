...
<?php 
	...
	if(isset($_POST['edit']))
	{
            ...
            if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "png") or ($ekstensifile == "PNG"))
		{
			...
			NAMAhotel = '$namahotel', ALAMAThotel = '$alamathotel',FOTOhotel = '$namafile' 
			WHERE IDhotel = '$idhotel'");
		}
	} else {
		mysqli_query($connection, "UPDATE hotel SET 
		IDhotel = '$idhotel' WHERE IDhotel = '$idhotel'");
	}
...
WHERE IDhotel = '$kodehotel'");
$rowedithotel = mysqli_fetch_array($edithotel);
...
<div class="jumbotron jumbotron-fluid">
		<div style="padding-left: 0; margin-bottom: 15px;" class="container">
			<h4 class="display-8">Input data hotel</h4>
		</div>
	</div>
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				value="<?php echo $rowedithotel['IDhotel']; ?>" readonly>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				value="<?php echo $rowedithotel['NAMAhotel']; ?>">
			</div>
		</div>
        ...
        <div class="form-group row">
			...
			<div class="col-sm-10">
				...
				value="<?php echo $rowedithotel['ALAMAThotel']; ?>">
			</div>
		</div>
		...
		<div style="margin-top: 10px;" class="form-group row">
			...
			<div class="col-sm-10">
				<td>
    	<?php if (!empty($row['FOTOhotel']) && is_file("images/".$row['FOTOhotel'])): ?>
        	<img src="images/<?php echo $row['FOTOhotel']?>" width="80" alt="Current Image">
    	<?php endif; ?>
	</td>
