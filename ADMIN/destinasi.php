...
<?php
    ...
    if(isset($_POST['Simpan'])) { //isset yang di kirim ada isinya atau tidak
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "png") or ($ekstensifile == "PNG"))
		{
			...
			mysqli_query($connection, "INSERT INTO destinasi (destinasiKODE, destinasiNAMA, kategoriKODE, destinasiKET, destinasiFOTO) 
            VALUES ('$destinasiKODE', '$destinasiNAMA', '$kategoriKODE', '$destinasiKET', '$namafile')");
		}
