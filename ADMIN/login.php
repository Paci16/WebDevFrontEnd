...
<html lang="en">
    ...
    <!--php buat sambungin ke php lain-->
    <?php

        include "include/config.php";

        //untuk menentukan kapan session aktif
        //maka menggunakan ob_start untuk menampung sesi dibawah
        ob_start();
        session_start();
              ...
              <div class="row">
                ...
                <div class="col-sm-7 _nb-pl">
                  <div class="_mn_df">
                    ...
                    <div class="form-group">
                      <input div class="_btn_04" type="submit" name="submitlogin" value="Login">
